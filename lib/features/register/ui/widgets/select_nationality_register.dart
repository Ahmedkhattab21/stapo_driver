...
class SelectNationalityRegister extends StatefulWidget {
  final SelectedCountry selectedCountry;

  const SelectNationalityRegister(
      {required this.selectedCountry, super.key});

  @override
  State<SelectNationalityRegister> createState() =>
      _SelectNationalityRegisterState();
}

class _SelectNationalityRegisterState
    extends State<SelectNationalityRegister> {
  @override
      ...
      children: [
        ...
        Expanded(
          child: DropdownButton<GetCountryResponse>(
              ...
              items: RegisterCubit.get(context).countries.map((status) {
